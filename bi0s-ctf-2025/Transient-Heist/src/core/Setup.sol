...
contract Setup{
    ...
    uint256 public constant SAFEMOON_INITIAL_LIQUIDITY=(WETH_INITIAL_LIQUIDITY*15087507543753773);
    ...
    uint256 public constant SAFEMOON_SECOND_LIQUIDITY=(WETH_SECOND_LIQUIDITY*15087507543753773); 
